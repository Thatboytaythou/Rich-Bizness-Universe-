...
type Snapshot = { rules?:Rule[]; access?:Access[]; profile?:Record<string,unknown> };
...
const isDimension=(value:string|null):value is DimensionKey=>Boolean(value&&value in DETAILS);
