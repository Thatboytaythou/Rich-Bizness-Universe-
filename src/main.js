...
(() => {
  ...
  addCss(`/src/index-hard-reset.css?v=${VERSION}`, 'rbHardReset'); addCss('/src/index-cinematic-plus.css?v=cinema-plus-1', 'rbIndexCinematicPlus'); addCss('/src/index-mobile-clean.css?v=mobile-clean-1', 'rbIndexMobileClean'); addModule(`/src/realtime-data.js?v=${VERSION}`, 'realtime');
