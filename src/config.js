...
export const RB_CONFIG = Object.freeze({
  ...
  routes: Object.freeze({ home:'/',feed:'/feed.html',live:'/live.html',watch:'/watch.html',gallery:'/gallery.html',music:'/music.html',upload:'/upload.html',gaming:'/gaming.html',sports:'/sports.html',meta:'/meta.html',store:'/store.html',messages:'/messages.html',notifications:'/notifications.html',search:'/search.html',profile:'/profile.html',edit:'/edit.html',avatar:'/avatar.html',settings:'/settings.html',auth:'/auth.html' }),
